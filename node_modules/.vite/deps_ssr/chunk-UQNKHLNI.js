  ...
  if (typeof value === "object" && value !== null) {
    ...
    if (is_array(value)) {
      ...
      for (var i = 0; i < value.length; i += 1) {
        ...
        if (i in value) {
          copy[i] = clone(element2, cloned, false_default ? `${path}[${i}]` : path, paths, null, no_tojson);
        }
      }
      return copy;
    }
...
function html(value) {
  ...
  var open = false_default ? `<!--${hash(html2)}-->` : "<!---->";
  return open + html2 + "<!---->";
}
...
function update_derived2(derived3, d = 1) {
  const value = derived3();
  let increase = typeof value === "bigint" ? BigInt(d) : d;
  derived3(value + /** @type {*} */
  increase);
  return value;
}
function update_derived_pre(derived3, d = 1) {
  const old_value = derived3();
...
export {
  ...
  props_id,
  derived2 as derived,
  update_derived2 as update_derived,
  update_derived_pre,
  async_derived2 as async_derived
};
//# sourceMappingURL=chunk-UQNKHLNI.js.map
