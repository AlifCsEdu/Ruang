...
// node_modules/astro/dist/assets/utils/inferSourceFormat.js
...
function inferSourceFormat(src) {
  ...
  try {
    ...
    const basename2 = lastSlash === -1 ? cleanSrc : cleanSrc.slice(lastSlash + 1);
    const lastDot = basename2.lastIndexOf(".");
    if (lastDot === -1) return void 0;
    return basename2.slice(lastDot + 1).toLowerCase();
  } catch {
    return void 0;
  }
}
...
//# sourceMappingURL=chunk-RZ3GBDYR.js.map
