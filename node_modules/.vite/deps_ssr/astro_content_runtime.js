import {
  createSvgComponent
} from "./chunk-VVW4CGFQ.js";
import {
  Traverse
} from "./chunk-OHETRTM2.js";
import {
  unflatten
} from "./chunk-AT2M5LDH.js";
import "./chunk-MYVXAIWJ.js";
...
import "./chunk-4BKAKEW5.js";
import {
  renderComponent
} from "./chunk-JBY4RH7H.js";
import "./chunk-AXXQPEDB.js";
import {
  renderTemplate
} from "./chunk-DXBUMNBC.js";
import "./chunk-BEYWD2WG.js";
import "./chunk-5DD6KKFC.js";
import "./chunk-3ZOQ2NKY.js";
import "./chunk-LRHDRBXX.js";
import "./chunk-LO3VJPNF.js";
...
import "./chunk-VXWHPWEC.js";
import "./chunk-NKHGVPZ5.js";
import "./chunk-4S6WKE4E.js";
import "./chunk-WEBCSDDJ.js";
...
import {
  createComponent
} from "./chunk-IHKIZN7G.js";
import "./chunk-TAJIKC5Y.js";
import "./chunk-LQQZ6AP2.js";
...
import {
  ...
  string,
  union
} from "./chunk-2Y4S5WIV.js";
import "./chunk-7N23VL2X.js";
import {
  VALID_INPUT_FORMATS
} from "./chunk-A4H2DFQV.js";
import "./chunk-WE2O6RXG.js";
import {
  isRemotePath,
  prependForwardSlash,
  removeBase
} from "./chunk-5QZ73HJY.js";
import "./chunk-EGRHWZRV.js";
import {
  AstroError,
  AstroUserError,
  errors_data_exports
} from "./chunk-3R4EIXEU.js";
...
var ImmutableDataStore = class _ImmutableDataStore {
...
var LiveCollectionError = class _LiveCollectionError extends Error {
  collection;
  message;
  cause;
  ...
  static is(error) {
    return error instanceof _LiveCollectionError;
  }
};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    if (collection in liveCollections) {
      throw new AstroError({
        ...errors_data_exports.UnknownContentCollectionError,
...
async function renderEntry(entry) {
  if (!entry) {
    throw new AstroError(errors_data_exports.RenderUndefinedEntryError);
  }
...
function defineCollection2(config) {
  if (config.type === "live") {
    throw new AstroError({
      ...errors_data_exports.LiveContentConfigError,
      message: errors_data_exports.LiveContentConfigError.message(
  ...
  return defineCollection(config);
}
...
function createDeprecatedFunction(functionName) {
  return (collection) => {
    const error = new AstroError({
      ...errors_data_exports.GetEntryDeprecationError,
      message: errors_data_exports.GetEntryDeprecationError.message(collection, functionName)
    });
...
export {
  ...
  createGetLiveEntry,
  createReference,
  defineCollection2 as defineCollection,
  defineLiveCollection,
  renderEntry,
  updateImageReferencesInData
};
//# sourceMappingURL=astro_content_runtime.js.map
