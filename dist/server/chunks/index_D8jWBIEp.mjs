...
import { C as escape_html, z as attr_class, B as ensure_array_like, H as derived, D as renderComponent, h as renderTemplate, m as maybeRenderHead, g as addAttribute, G as renderTransition } from "./worker-entry_BueQH5e0.mjs";
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Calendar — Ruang" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-3xl mx-auto px-4 py-8"${addAttribute(renderTransition($$result2, "iqbfx27j", "", "page-hijri"), "data-astro-transition-scope")}> <!-- Header --> <div class="mb-8"> <h1 class="text-3xl font-black uppercase tracking-wider">Calendar</h1> <p class="text-sm font-bold text-ink/60 mt-1">Gregorian + Hijri calendar with Malaysian holidays</p> </div> <!-- Interactive Calendar --> ${renderComponent($$result2, "CalendarGrid", CalendarGrid, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/components/hijri/CalendarGrid.svelte", "client:component-export": "default" }, { "default": ($$result3) => renderTemplate` <div class="text-center py-12 animate-pulse"> <p class="font-black text-ink/40 uppercase tracking-wider">Loading calendar...</p> </div> ` })} </div> ` })}`;
}, "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/pages/hijri/index.astro", "self");
