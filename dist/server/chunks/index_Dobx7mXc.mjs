...
import { C as escape_html, B as ensure_array_like, z as attr_class, y as attr, J as stringify, O as attr_style, G as derived, D as renderComponent, h as renderTemplate, m as maybeRenderHead } from "./worker-entry_C-jIstQk.mjs";
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Prayer Tracker — Ruang" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-2xl mx-auto px-4 py-8"> <h1 class="text-3xl font-black uppercase tracking-wider mb-6">Prayer Tracker</h1> ${renderComponent($$result2, "PrayerTracker", PrayerTracker, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/components/tracker/PrayerTracker.svelte", "client:component-export": "default" })} </div> ` })}`;
}, "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/pages/tracker/index.astro", void 0);
