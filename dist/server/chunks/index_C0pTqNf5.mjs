...
import { B as ensure_array_like, z as attr_class, C as escape_html, O as attr_style, J as stringify, y as attr, G as derived, D as renderComponent, h as renderTemplate, m as maybeRenderHead } from "./worker-entry_C-jIstQk.mjs";
import { B as BeadsIcon, $ as $$BaseLayout } from "./BaseLayout_UTZfyRfD.mjs";
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Tasbih — Ruang" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-md mx-auto px-4 py-8"> <h1 class="text-3xl font-black uppercase tracking-wider mb-6">Tasbih Counter</h1> ${renderComponent($$result2, "Tasbih", Tasbih, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/components/tasbih/Tasbih.svelte", "client:component-export": "default" })} </div> ` })}`;
}, "C:/Users/alif325/Documents/WIndsurf projeks/Ruang/src/pages/tasbih/index.astro", void 0);
